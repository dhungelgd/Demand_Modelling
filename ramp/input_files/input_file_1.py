...
P1_RLI_lamp.windows([18*60,23*60],[5*60,7*60],0.35)

P1_RLI_fan = P1_RLI.Appliance(P1_RLI,1,75,1,720,0.2,15)
P1_RLI_fan.windows([0,24*60],[0,0],0.35)

P1_RLI_TV = P1_RLI.Appliance(P1_RLI,1,120,2,360,0.1,30)
P1_RLI_TV.windows([12*60,14*60],[18*60,22*60+30],0.35)
...
#Prototype 1a : residential shantys: urban low income households
P1_ULI_lamp = P1_ULI.Appliance(P1_ULI,2,60,2,360,0.2,10,wd_we_type = 2)
P1_ULI_lamp.windows([18*60,24*60],[5*60,8*60],0.35)

P1_ULI_fan = P1_ULI.Appliance(P1_ULI,1,75,1,720,0.2,15)
P1_ULI_fan.windows([0,24*60],[0,0],0.35)

P1_ULI_TV = P1_ULI.Appliance(P1_ULI,1,120,2,360,0.1,30)
P1_ULI_TV.windows([12*60,14*60],[18*60,22*60+30],0.35)
...
P1_ULI_Rice_Cooker = P1_ULI.Appliance(P1_ULI,1,80,3,240,0.2,30)
P1_ULI_Rice_Cooker.windows([6*60,10*60],[12*60,15*60],0.35,[17*60,20*60])
#
#Prototype 2 : Middle income houses
P2_RMI_lamp = P2_RMI.Appliance(P2_RMI,8,15,2,360,0.2,10,wd_we_type = 2)
P2_RMI_lamp.windows([18*60,23*60],[5*60,7*60],0.35)

P2_RMI_fan = P2_RMI.Appliance(P2_RMI,2,75,1,720,0.2,15)
P2_RMI_fan.windows([0,24*60],[0,0],0.35)

P2_RMI_TV = P2_RMI.Appliance(P2_RMI,1,120,2,420,0.1,30)
P2_RMI_TV.windows([11*60,14*60],[18*60,22*60+30],0.35)
...
P2_RMI_Rice_Cooker = P2_RMI.Appliance(P2_RMI,1,80,3,240,0.2,30)
P2_RMI_Rice_Cooker.windows([6*60,10*60],[12*60,15*60],0.35,[17*60,20*60])
...
P3_UHI_lamp = P3_UHI.Appliance(P3_UHI,10,15,2,360,0.2,10,wd_we_type = 2)
P3_UHI_lamp.windows([5*60,7*60],[18*60,23*60],0.35)

P3_UHI_fan = P3_UHI.Appliance(P3_UHI,2,75,1,240,0.2,15)
P3_UHI_fan.windows([0,24*60],[0,0],0.35)

P3_UHI_TV = P3_UHI.Appliance(P3_UHI,1,120,2,480,0.1,30)
P3_UHI_TV.windows([12*60,14*60],[18*60,22*60+30],0.35)
...
P3_UHI_Rice_Cooker = P3_UHI.Appliance(P3_UHI,2,80,3,240,0.2,30)
P3_UHI_Rice_Cooker.windows([6*60,10*60],[12*60,15*60],0.35,[17*60,20*60])
...
P3_UHI_Air_Conditioner = P3_UHI.Appliance(P3_UHI,1,500,2,300,0.2,15,occasional_use=1)
P3_UHI_Air_Conditioner.windows([22*60+30,24*60],[0,7*60],0.35)

P3_UHI_Microwave= P3_UHI.Appliance(P3_UHI,1,1000,3,10,0.2,5,thermal_P_var=0.3,occasional_use = 0.33)
P3_UHI_Microwave.windows([8*60,9*60],[11*60,13*60],0.35,[18*60,21*60])
#
...
P4_UMI_lamp = P4_UMI.Appliance(P4_UMI,8,15,2,360,0.2,10,wd_we_type = 2)
P4_UMI_lamp.windows([5*60,7*60],[18*60,23*60],0.35)

P4_UMI_fan = P4_UMI.Appliance(P4_UMI,2,75,1,720,0.2,15)
P4_UMI_fan.windows([0,24*60],[0,0],0.35)

P4_UMI_TV = P4_UMI.Appliance(P4_UMI,1,120,2,480,0.1,30)
P4_UMI_TV.windows([12*60,15*60],[18*60,22*60+30],0.35)
...
P4_UMI_Rice_Cooker = P4_UMI.Appliance(P4_UMI,1,80,3,240,0.2,30)
P4_UMI_Rice_Cooker.windows([6*60,10*60],[12*60,15*60],0.35,[17*60,20*60])
...
P5_UMIX_lamp1 = P5_UMIX.Appliance(P5_UMIX,8,15,2,360,0.2,10,wd_we_type = 2)
P5_UMIX_lamp1.windows([5*60,7*60],[18*60,23*60],0.35)

P5_UMIX_lamp2 = P5_UMIX.Appliance(P5_UMIX,10,30,1,360,0.2,10,wd_we_type = 0)
P5_UMIX_lamp2.windows([9*60,19*60],[0,0],0.1)

P5_UMIX_fan1 = P5_UMIX.Appliance(P5_UMIX,2,75,1,240,0.2,15)
P5_UMIX_fan1.windows([0,24*60],[0,0],0.35)
...
P5_UMIX_TV1.windows([12*60,14*60],[18*60,22*60+30],0.35)
...
P5_UMIX_Rice_Cooker = P5_UMIX.Appliance(P5_UMIX,1,80,3,240,0.2,30)
P5_UMIX_Rice_Cooker.windows([6*60,10*60],[12*60,15*60],0.35,[17*60,20*60])
...
P5_UMIX_Air_Conditioner1 = P5_UMIX.Appliance(P5_UMIX,1,500,2,300,0.2,15,occasional_use=1)
P5_UMIX_Air_Conditioner1.windows([22*60+30,24*60],[0,7*60],0.35)
