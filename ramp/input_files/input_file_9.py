...
P3_UHI_fan = P3_UHI.Appliance(P3_UHI,2,75,3,480,0.2,15)
P3_UHI_fan.windows([11*60,16*60],[19*60,24*60],0.35,[0,6*60])
...
P3_UHI_Air_Conditioner = P3_UHI.Appliance(P3_UHI,1,500,3,300,0.2,15,occasional_use=0.2)
...
P5_UMIX_fan1 = P5_UMIX.Appliance(P5_UMIX,2,75,3,480,0.2,15)
P5_UMIX_fan1.windows([11*60,16*60],[19*60,24*60],0.35,[0,6*60])
...
P5_UMIX_Air_Conditioner1 = P5_UMIX.Appliance(P5_UMIX,1,500,3,180,0.2,15,occasional_use=0.3)
