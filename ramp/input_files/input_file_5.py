...
P3_UHI_Air_Conditioner = P3_UHI.Appliance(P3_UHI,1,500,3,300,0.2,15,occasional_use=0.7)
...
P5_UMIX_Air_Conditioner1 = P5_UMIX.Appliance(P5_UMIX,1,500,3,300,0.2,15,occasional_use=0.8)
