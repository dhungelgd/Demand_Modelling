...
def Stochastic_Process(full_month, year, month, j):
    Profile, num_profiles = Initialise_model(full_month, year,month)
    peak_enlarg, mu_peak, s_peak,op_factor, Year_behaviour, User_list = Initialise_inputs(year,month, j)
    '''
